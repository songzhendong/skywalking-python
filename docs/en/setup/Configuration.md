...
| agent_ssl_key_path | SW_AGENT_SSL_KEY_PATH | <class 'str'> |  | PEM of the agent private key for mTLS (unencrypted). Used with agent_ssl_cert_chain_path (Java agent.ssl_key_path). |
